...
class ServiceTypesController extends AppController
{
    ...
    public function index()
    {
        ...
        $serviceTypes = $this->ServiceTypes->find()->contain(['ServiceStreams']);
    ...
    public function add()
    {
        ...
        $serviceStreams = $this->ServiceTypes->ServiceStreams->find('list', ['limit' => 200])->all();
        $this->set(compact('serviceType', 'serviceStreams'));
    }
    ...
    public function delete($id = null)
    {
        ...
        $serviceType = $this->ServiceTypes->get($id);
        $this->ServiceTypes->Services->deleteAll(['service_type_id' => $id]);
