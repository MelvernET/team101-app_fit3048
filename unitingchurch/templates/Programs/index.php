            ...
            <?php foreach ($programs as $program): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $program->program_id], ['class' => 'btn btn-primary btn-sm', 'confirm' => __('Are you sure you want to delete {0}?', $programr->program_name)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
