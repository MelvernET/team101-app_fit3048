 ...
 * @var iterable<\App\Model\Entity\Record> $record
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $record->has('user') ? $this->Html->link($record->user->user_id, ['controller' => 'User', 'action' => 'view', $record->user->user_id]) : '' ?></td>
                    <td><?= $record->has('client') ? $this->Html->link($record->client->client_id, ['controller' => 'Client', 'action' => 'view', $record->client->client_id]) : '' ?></td>
