            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user->user_id], ['class' => 'btn btn-primary btn-sm', 'confirm' => __('Are you sure you want to delete {0}?', $user->user_first_name)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
