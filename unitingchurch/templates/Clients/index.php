            ...
            <?php foreach ($clients as $client): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $client->client_id], ['class' => 'btn btn-primary btn-sm', 'confirm' => __('Are you sure you want to delete {0}?', $client->client_first_name)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
