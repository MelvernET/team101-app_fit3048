        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $service->has('program') ? $this->Html->link($service->program->program_id, ['controller' => 'Program', 'action' => 'view', $service->program->program_id]) : '' ?></td>
                    <td><?= $service->has('service_type') ? $this->Html->link($service->service_type->service_type_id, ['controller' => 'ServiceType', 'action' => 'view', $service->service_type->service_type_id]) : '' ?></td>
                    <td class="actions">
