 ...
 * @var iterable<\App\Model\Entity\ServiceType> $serviceType
 */
?>
<div class="serviceType index content">
    <?= $this->Html->link(__('New Service Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Service Type') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $serviceType->has('service_stream') ? $this->Html->link($serviceType->service_stream->service_stream_id, ['controller' => 'ServiceStream', 'action' => 'view', $serviceType->service_stream->service_stream_id]) : '' ?></td>
                    <td class="actions">
