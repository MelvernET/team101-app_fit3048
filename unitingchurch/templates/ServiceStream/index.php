 ...
 * @var iterable<\App\Model\Entity\ServiceStream> $serviceStream
 */
?>
<div class="serviceStream index content">
    <?= $this->Html->link(__('New Service Stream'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Service Stream') ?></h3>
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php foreach ($serviceStream as $serviceStream): ?>
                <tr>
