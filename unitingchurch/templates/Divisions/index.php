...
<div class="divisions index content">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 headings"><?= __('Divisions') ?></h1>
            ...
            <?php foreach ($divisions as $division): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $division->division_id], ['class' => 'btn btn-primary btn-sm', 'confirm' => __('Are you sure you want to delete {0}?', $division->division_name)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
